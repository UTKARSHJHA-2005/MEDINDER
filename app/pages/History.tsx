...
const History = () => {
    ...
    useEffect(() => {
        const expired = medicine.filter((item) => getDaysRemaining(item.endDate).text === 'Expired');
        console.log('Expired meds:', expired);
    }, [medicine]);
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Text style={styles.head}>View Your History</Text>
            <Stack.Screen options={{ headerShown: false }} />
            <StatusBar barStyle="light-content" backgroundColor="#667EEA" />
            <FlatList
                data={medicine.filter((item) => getDaysRemaining(item.endDate).text === 'Expired')}
                ...
                ListEmptyComponent={
                    <Animated.View style={[styles.emptyContainer, { opacity: fadeAnim }]}>
                        ...
                        <Text style={styles.emptyTitle}>No Expired Medications</Text>
                        <Text style={styles.emptySubtitle}>
                            You're all caught up!{'\n'}No medications have expired.
                        </Text>
                    </Animated.View>
                }
