...
GoogleSignin.configure({
  webClientId:
    "70506501293-b2pi75ees1234u0bb6ls9iac3g7iuoej.apps.googleusercontent.com",
});
const Login = () => {
  // const app = getApp();
  ...
  const CLIENT_ID =
    "521789138294-lg66qlkesrnevf1crb3n8a9sbfaihq1v.apps.googleusercontent.com";
